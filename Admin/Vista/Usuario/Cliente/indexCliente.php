              ...
              <?php 
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) { 
                            ...
                            echo " <td>" . $row['foto'] . "</td>";
                            echo " <td><a class='btn btn-success btn-sm' href='/SistemadeGestion/Admin/Controladores/Usuario/Cliente/agregarCarrito.php?id=" . $row['id'] ."'>Agregar</a></td>";
                            echo "</tr>";
                        }
                    } else {
                        echo "<tr>";
                ...
                <?php 
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) { 
                            ...
                            echo " <td>" . $row['estado'] . "</td>";
                            echo " <td><a class='btn btn-danger btn-sm' href='/SistemadeGestion/Admin/Controladores/Usuario/Cliente/eliminarCarrito.php?id=" . $row['id'] ."'>Eliminar</a></td>";
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="pull-right">
                  <a href="/SistemadeGestion/Admin/Controladores/Usuario/Cliente/pagarCarrito.php" class="btn btn-primary"><span class="glyphicon glyphicon-plus">
                  </span>Pagar</a>
